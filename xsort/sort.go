...
// SortableAsc is a function that takes in a slice of type T and sorts it in ascending order. The type T must implement the Sortable interface, which requires the Less() method to be defined.
...
// SortableDesc is a function that takes in a slice of type T, where T is a type that implements the Sortable interface.
